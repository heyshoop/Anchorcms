...
import com.anchorcms.cms.dao.assist.SensitivityDao;
...
@Repository
public class SensitivityDaoImpl extends
		HibernateBaseDao<CmsSensitivity, Integer> implements SensitivityDao {
