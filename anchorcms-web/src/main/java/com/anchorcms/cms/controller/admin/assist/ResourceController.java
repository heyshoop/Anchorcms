...
public class ResourceController {
	...
	public String tree(HttpServletRequest request,
		...
		List<? extends FileWrap> resList = resourceService.listFile(root, true);
	...
	public String list(HttpServletRequest request, ModelMap model) {
		...
		model.addAttribute("list", resourceService.listFile(root, false));
	...
	public String createDir(String root, String dirName,
		...
		// TODO 检查dirName是否存在
		resourceService.createDir(root, dirName);
		model.addAttribute("root", root);
	...
	public String edit(HttpServletRequest request, ModelMap model)
		...
		model.addAttribute("source", resourceService.readFile(name));
		model.addAttribute("root", root);
	...
	public String save(String root, String filename, String source,
		...
		resourceService.createFile(request,root, filename, source);
		model.addAttribute("root", root);
		log.info("save Resource name={}", filename);
		logService.operating(request, "resource.log.save", "filename="
				+ filename);
	...
	public void update(String root, String name, String source,
		...
		resourceService.updateFile(name, source);
		log.info("update Resource name={}.", name);
		logService.operating(request, "resource.log.update", "filename=" + name);
		model.addAttribute("root", root);
	...
	public void swfUpload(
		...
		resourceService.saveFile(request,root, file);
		model.addAttribute("root", root);
