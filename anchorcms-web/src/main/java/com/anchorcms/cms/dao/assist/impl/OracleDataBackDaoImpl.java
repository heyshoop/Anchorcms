...
@Repository
public class OracleDataBackDaoImpl extends JdbcDaoSupport implements
		OracleDataBackDao {
	...
	private boolean isDateTimeColumn(String tablename,int columnIndex){
		if(StringUtils.isNotBlank(tablename)){
			...
			if(upperTableName.equals("C_ACQUISITION")){
				if(columnIndex==7||columnIndex==8){
					return true;
				}
			}
			if(upperTableName.equals("C_ADVERTISING")){
				if(columnIndex==10||columnIndex==11){
					return true;
				}
			}
			if(upperTableName.equals("C_COMMENT")){
				if(columnIndex==6||columnIndex==7){
					return true;
				}
			}
			if(upperTableName.equals("C_CONTENT")){
				if(columnIndex==7){
					return true;
				}
			}
			if(upperTableName.equals("C_CONTENT_CHECK")){
				if(columnIndex==6){
					return true;
				}
			}
			if(upperTableName.equals("C_CONTENT_EXT")){
				if(columnIndex==8){
					return true;
				}
			}
			if(upperTableName.equals("C_GUESTBOOK")){
				if(columnIndex==7||columnIndex==8){
					return true;
				}
			}
			if(upperTableName.equals("C_LOG")){
				if(columnIndex==5){
					return true;
				}
			}
			if(upperTableName.equals("C_MESSAGE")){
				if(columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("C_RECEIVER_MESSAGE")){
				if(columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("C_SITE_FLOW")){
				if(columnIndex==5){
					return true;
				}
			}
			if(upperTableName.equals("C_USER")){
				if(columnIndex==6||columnIndex==8||columnIndex==14){
					return true;
				}
			}
			if(upperTableName.equals("C_USER_EXT")){
				if(columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("C_VOTE_RECORD")){
				if(columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("C_VOTE_TOPIC")){
				if(columnIndex==5||columnIndex==6){
					return true;
				}
			}
			if(upperTableName.equals("O_AUTHENTICATION")){
				if(columnIndex==5||columnIndex==7){
					return true;
				}
			}
			if(upperTableName.equals("O_USER")){
				if(columnIndex==5||columnIndex==7||columnIndex==12){
					return true;
				}
			}
			if(upperTableName.equals("C_JOB_APPLY")){
				if(columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("C_WORKFLOW_EVENT")){
				if(columnIndex==5||columnIndex==6){
					return true;
				}
			}
			if(upperTableName.equals("C_WORKFLOW_RECORD")){
				if(columnIndex==5){
					return true;
				}
			}
			if(upperTableName.equals("C_TASK")){
				if(columnIndex==19){
					return true;
				}
			}
			if(upperTableName.equals("C_USER_RESUME")){
				if(columnIndex==8||columnIndex==16){
					return true;
				}
			}
			if(upperTableName.equals("C_PLUG")){
				if(columnIndex==6||columnIndex==7||columnIndex==8){
					return true;
				}
			}
			if(upperTableName.equals("C_SITE_ACCESS")){
				if(columnIndex==4||columnIndex==5){
					return true;
				}
			}
			if(upperTableName.equals("C_SITE_ACCESS_PAGES")){
				if(columnIndex==4||columnIndex==5){
					return true;
				}
			}
			if(upperTableName.equals("C_SITE_ACCESS_COUNT")){
				if(columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("C_SITE_ACCESS_STATISTIC")){
				if(columnIndex==2){
					return true;
				}
			}
			if(upperTableName.equals("C_CONFIG")){
				if(columnIndex==21||columnIndex==22||columnIndex==36||columnIndex==37){
					return true;
				}
			}
			if(upperTableName.equals("C_CONTENT_BUY")){
				if(columnIndex==9){
					return true;
				}
			}
			if(upperTableName.equals("C_CONTENT_CHARGE")){
				if(columnIndex==7){
					return true;
				}
			}
			if(upperTableName.equals("C_CONFIG_CONTENT_CHARGE")){
				if(columnIndex==18){
					return true;
				}
			}
			if(upperTableName.equals("C_USER_ACCOUNT")){
				if(columnIndex==13||columnIndex==14){
					return true;
				}
			}
			if(upperTableName.equals("C_ACCOUNT_DRAW")){
				if(columnIndex==7){
					return true;
				}
			}
			if(upperTableName.equals("C_ACCOUNT_PAY")){
				if(columnIndex==7){
					return true;
				}
			}
	...
	private boolean isColbColumn(String tablename,int columnIndex){
		if(StringUtils.isNotBlank(tablename)){
			...
			if(upperTableName.equals("C_CHANNEL_TXT")){
				//TXT TXT1 TXT2 TXT3
				if(columnIndex==2||columnIndex==3||columnIndex==4||columnIndex==5){
					return true;
				}
			}
			if(upperTableName.equals("C_COMMENT_EXT")){
				//TEXT REPLY
				if(columnIndex==3||columnIndex==4){
					return true;
				}
			}
			if(upperTableName.equals("C_CONTENT_TXT")){
				//TXT TXT1 TXT2 TXT3
				if(columnIndex==2||columnIndex==3||columnIndex==4||columnIndex==5){
					return true;
				}
			}
			if(upperTableName.equals("C_GUESTBOOK_EXT")){
				//CONTENT REPLY
				if(columnIndex==3||columnIndex==4){
					return true;
				}
			...
			if(upperTableName.equals("C_SITE_TXT")){
				//TXT_VALUE
				if(columnIndex==3){
					return true;
				}
			}
			if(upperTableName.equals("C_SITE_COMPANY")){
				//DESCRIPTION
				if(columnIndex==7){
					return true;
				}
			}
			if(upperTableName.equals("C_VOTE_REPLY")){
				//REPLY
				if(columnIndex==2){
					return true;
				}
			...
			if(upperTableName.equals("C_DIRECTIVE_TPL")){
				//JOB_DESCRIPTION
				if(columnIndex==4){
					return true;
				}
