...
import com.anchorcms.cms.dao.assist.AcquisitionDao;
...
public class AcquisitionServiceImpl implements AcquisitionService,
	...
	public CmsAcquisition save(CmsAcquisition bean, Integer channelId,
		...
		bean.setUser(userService.findById(userId));
	...
	public Content saveContent(String title, String txt, String origin,
		...
		ctxt.setTxt(txt);
		Content content = contentService.save(c, cext, ctxt,null, null, null,
	...
	@Resource
	private AcquisitionDao dao;
	@Resource
	private ModelService modelMng;
	@Resource
	private AcquisitionHistoryService acquisitionHistoryMng;
}