...
import com.anchorcms.core.service.RoleService;
...
public class RoleController {
	...
	public String save(CmsRole bean, String[] perms,
		...
		logService.operating(request, "cmsRole.log.save", "id=" + bean.getRoleId()
	...
	public String update(CmsRole bean, String[] perms, boolean all,
		...
		logService.operating(request, "cmsRole.log.update", "id=" + bean.getRoleId()
				+ ";name=" + bean.getRoleName());
	...
	public String delete(Integer[] ids, HttpServletRequest request,
		...
		for (CmsRole bean : beans) {
			...
			logService.operating(request, "cmsRole.log.delete", "id="
