...
import com.anchorcms.cms.dao.assist.MessageDao;
...
@Repository
public class MessageDaoImpl extends HibernateBaseDao<CmsMessage, Integer>
	...
	public Pagination getPage(Integer siteId, Integer sendUserId,
		...
		if(sendUserId != null&&receiverUserId != null){
			finder.append(" and (msg.msgSendUser=:sendUserId or msg.msgReceiverUser=:receiverUserId)").setParam(
