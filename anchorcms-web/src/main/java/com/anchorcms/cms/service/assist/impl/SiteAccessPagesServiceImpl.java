...
import com.anchorcms.cms.dao.assist.SiteAccessPagesDao;
...
@Service
@Transactional
public class SiteAccessPagesServiceImpl implements SiteAccessPagesService {
	...
	@Autowired
	private SiteAccessPagesDao dao;
