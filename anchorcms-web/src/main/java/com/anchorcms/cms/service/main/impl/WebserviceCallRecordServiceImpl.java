...
import com.anchorcms.cms.dao.main.WebserviceCallRecordDao;
...
@Service
@Transactional
public class WebserviceCallRecordServiceImpl implements WebserviceCallRecordService {
	...
	@Resource
	private WebserviceAuthService bbsWebserviceAuthMng;
	@Resource
