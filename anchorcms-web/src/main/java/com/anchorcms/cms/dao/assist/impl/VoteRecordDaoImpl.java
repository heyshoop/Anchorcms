...
import com.anchorcms.cms.dao.assist.VoteRecordDao;
...
@Repository
public class VoteRecordDaoImpl extends
		HibernateBaseDao<CmsVoteRecord, Integer> implements VoteRecordDao {
