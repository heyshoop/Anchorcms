...
public class GuestbookController {
	...
	public String list(Integer queryCtgId, Boolean queryRecommend,
		...
		Integer[] ctgIds;
		List<CmsGuestbookCtg> list= guestbookCtgService.getList(site.getSiteId());
		...
		model.addAttribute("ctgList", guestbookCtgService.getList(site.getSiteId()));
	...
	public String add(HttpServletRequest request, ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		List<CmsGuestbookCtg> ctgList = guestbookCtgService
	...
	public String save(CmsGuestbook bean, CmsGuestbookExt ext, Integer ctgId,
		...
		log.info("save CmsGuestbook id={}", bean.getGuestbookId());
		logService.operating(request, "cmsGuestbook.log.save", "id="
	...
	public String update(Integer queryCtgId, Boolean queryRecommend,
		...
		log.info("update CmsGuestbook id={}.", bean.getGuestbookId());
		logService.operating(request, "cmsGuestbook.log.update", "id="
				+ bean.getGuestbookId() + ";title=" + bean.getExt().getTitle());
	...
	public String delete(Integer queryCtgId, Boolean queryRecommend,
		...
		for (CmsGuestbook bean : beans) {
			log.info("delete CmsGuestbook id={}",  bean.getGuestbookId());
			logService.operating(request, "cmsGuestbook.log.update", "id="
					+ bean.getGuestbookId() + ";title=" + bean.getExt().getTitle());
		}
		return list(queryCtgId, queryRecommend, queryChecked, pageNo, request,
	...
	@Resource
	private GuestbookService manager;
}