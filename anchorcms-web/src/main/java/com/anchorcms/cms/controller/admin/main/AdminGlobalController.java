 ...
 */
@Controller
public class AdminGlobalController extends AdminAbstrController {
	private static final Logger log = LoggerFactory
			.getLogger(AdminGlobalController.class);
	...
	public String save(CmsUser bean, CmsUserExt ext, String username,
		...
		bean = manager.saveAdmin(username, email, password, ip, false,
				...
				allChannels,ext);
		webserviceService.callWebService("true",username, password, email,
	...
	public String update(CmsUser bean, CmsUserExt ext, String password,
		...
		webserviceService.callWebService("true",bean.getUsername(), password,
