...
public class ModelItemController {
	private static final Logger log = LoggerFactory
			.getLogger(ModelItemController.class);
	...
	public String list(Integer modelId, Boolean isChannel,
		...
		List<CmsModelItem> list = modelItemService.getList(modelId, isChannel, true);
	...
	public String edit(Integer id, HttpServletRequest request, ModelMap model) {
		...
		CmsModelItem item = modelItemService.findById(id);
	...
	public String priority(Integer[] wids, Integer[] priority, String[] label,
		...
		if (wids != null && wids.length > 0) {
			modelItemService.updatePriority(wids, priority, label, single, display);
		}
	...
	public String saveList(Integer modelId, Boolean isChannel, String[] fields,
		...
		modelItemService.saveList(itemList);
	...
	public String save(CmsModelItem bean, Integer modelId, Boolean isChannel,
		...
		bean = modelItemService.save(bean, modelId);
	...
	public String update(CmsModelItem bean, HttpServletRequest request,
		...
		bean = modelItemService.update(bean);
		log.info("update CmsModelItem id={}.", bean.getModelitemId());
		model.addAttribute("modelId", bean.getModel().getModelId());
		model.addAttribute("isChannel", bean.getIsChannel());
		return "redirect:v_list.do";
	...
	public String delete(Integer[] ids, Integer modelId, Boolean isChannel,
		...
		CmsModelItem[] beans = modelItemService.deleteByIds(ids);
	...
	private boolean vldExist(Integer id, WebErrors errors) {
		...
		CmsModelItem entity = modelItemService.findById(id);
