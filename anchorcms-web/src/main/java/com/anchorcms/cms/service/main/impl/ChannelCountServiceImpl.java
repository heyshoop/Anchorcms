...
import com.anchorcms.cms.service.main.ChannelCountService;
...
public class ChannelCountServiceImpl implements ChannelCountService {
	...
	private int clearCount(CmsConfig config) {
		...
		if (currDay != lastDay) {
			...
			configService.updateCountClearTime(curr.getTime());
	...
	private int clearContentCount(CmsConfig config) {
		...
		if (currDay != lastDay) {
			...
			configService.updateChannelCountClearTime(curr.getTime());
