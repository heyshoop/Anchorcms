...
import com.anchorcms.cms.service.assist.TaskService;
...
public class TaskController {
	...
	public String add(HttpServletRequest request,ModelMap model) {
		...
		List<CmsAcquisition>acquList=acquisitionService.getList(CmsUtils.getSiteId(request));
		// 栏目列表
	...
	public String save(CmsTask bean, HttpServletRequest request, ModelMap model) throws ParseException, SchedulerException, ClassNotFoundException {
		...
		if(bean.getTaskType().equals(CmsTask.TASK_STATIC_INDEX)){
			attrs.put(CmsTask.TASK_PARAM_SITE_ID,siteId);
			bean.setAttr(attrs);
		}else if(bean.getTaskType().equals(CmsTask.TASK_STATIC_CHANNEL)||bean.getTaskType().equals(CmsTask.TASK_STATIC_CONTENT)){
			attrs.put(CmsTask.TASK_PARAM_SITE_ID, siteId);
		}
		bean.setAttr(attrs);
