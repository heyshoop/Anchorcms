...
@Controller
public class GuestbookCtgController {
	private static final Logger log = LoggerFactory
			.getLogger(GuestbookCtgController.class);
	...
	public String list(Integer pageNo, HttpServletRequest request,
		...
		List<CmsGuestbookCtg> list = manager.getList(site.getSiteId());
	...
	public void ajaxEdit(Integer id, HttpServletRequest request,HttpServletResponse response, ModelMap model) throws JSONException {
		...
		if(ctg!=null){
			object.put("id", ctg.getGuestbookctgId());
			object.put("name", ctg.getCtgName());
	...
	public String save(CmsGuestbookCtg bean, HttpServletRequest request,
		...
		log.info("save CmsGuestbookCtg id={}", bean.getGuestbookctgId());
		logService.operating(request, "cmsGuestbookCtg.log.save", "id="
				+ bean.getGuestbookctgId() + ";name=" + bean.getCtgName());
	...
	public String update(CmsGuestbookCtg bean, Integer pageNo,
		...
		WebErrors errors = validateUpdate(bean.getGuestbookctgId(), request);
		if (errors.hasErrors()) {
			return errors.showErrorPage(model);
		}
		bean = manager.update(bean);
		log.info("update CmsGuestbookCtg id={}.", bean.getGuestbookctgId());
		logService.operating(request, "cmsGuestbookCtg.log.update", "id="
				+ bean.getGuestbookctgId() + ";name=" + bean.getCtgName());
	...
	public String delete(Integer[] ids, Integer pageNo,
		...
		for (CmsGuestbookCtg bean : beans) {
			log.info("delete CmsGuestbookCtg id={}", bean.getGuestbookctgId());
			logService.operating(request, "cmsGuestbookCtg.log.delete", "id="
					+ bean.getGuestbookctgId() + ";name=" + bean.getCtgName());
		}
		return list(pageNo, request, model);
	}
	...
	@Resource
	private GuestbookCtgService manager;
}